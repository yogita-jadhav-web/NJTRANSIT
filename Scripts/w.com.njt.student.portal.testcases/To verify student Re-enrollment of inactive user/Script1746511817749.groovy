...
WebUI.setText(findTestObject('Object Repository/Student_Portal/Page_Sign In  NJ Transit/input_Email_email'), 'studec12@mailinator.com')
...
WebUI.verifyElementText(findTestObject('Object Repository/Student_Portal/Page_Sign In  NJ Transit/div_Your NJ TRANSIT E-Ticketing account is _1f0f5a_1'), 
    'Your NJ TRANSIT E-Ticketing account is not active yet. Please activate using the email sent by NJTransit.')

WebUI.verifyElementText(findTestObject('Object Repository/Student_Portal/Page_Sign In  NJ Transit/p_Your NJ TRANSIT E-Ticketing account is no_7f4164'), 
    'Your NJ TRANSIT E-Ticketing account is not active yet. Please activate using the email sent by NJTransit.')
