...
not_run: WebUI.verifyElementPresent(findTestObject('Page_lthyddyw Mailbox  Maildrop/td_Hi wbMyQh,                              _e90faf'), 
    0)

WebUI.click(findTestObject('Page_Maildrop_Email template - Student account registration/Page_Maildrop_Email template - Student account registration/Verify email address link'))
...
WebUI.verifyElementPresent(findTestObject('Page_Maildrop_Email template - Student account registration/paragraph1-success dialog'), 
    0)
