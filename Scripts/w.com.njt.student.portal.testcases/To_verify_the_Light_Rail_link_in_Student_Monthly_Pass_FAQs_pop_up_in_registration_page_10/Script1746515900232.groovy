...
WebUI.verifyElementText(findTestObject('student_Registartion_Page_Object_Repository/Page_Create Account  NJ Transit/a_light rail'), 
    'light rail')

WebUI.click(findTestObject('student_Registartion_Page_Object_Repository/Page_Create Account  NJ Transit/a_light rail'))

WebUI.switchToWindowIndex(1)

String actualUrl = WebUI.getUrl()

String expectedUrl = GlobalVariable.Light_Rail_URL
