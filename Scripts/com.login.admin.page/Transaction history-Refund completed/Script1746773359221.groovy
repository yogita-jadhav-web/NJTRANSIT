...
*/
WebUI.verifyElementText(findTestObject('Admin portal _TC_objectRepo/Page_Conduent Transport Solutions, Inc/a_Refund Completed'), 
    'Refund Completed')

//WebUI.scrollToElement(findTestObject('Admin portal _TC_objectRepo/Page_Conduent Transport Solutions, Inc/button_TR'), 0)
WebUI.click(findTestObject('Admin portal _TC_objectRepo/Page_Conduent Transport Solutions, Inc/a_Refund Completed'))
