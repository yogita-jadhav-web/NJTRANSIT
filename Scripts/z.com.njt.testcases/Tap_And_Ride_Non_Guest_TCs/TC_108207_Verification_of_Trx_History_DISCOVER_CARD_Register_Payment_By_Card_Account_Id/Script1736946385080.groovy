...
not_run: WebUI.click(findTestObject('Button Txhistory_Object repo/Page_Tap  Ride Dashboard  NJ Transit/button_TRX. History'))
...
not_run: WebUI.callTestCase(findTestCase('com.tap.and.ride.guest.page/Verify_Trip_Transactions_Details'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('com.tap.and.ride.non.guest.page/Verify_Trip_Transactions_Details_Discover'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('com.tap.and.ride.non.guest.page/Verify_Trip_Details_Discover card'), [:], FailureHandling.STOP_ON_FAILURE)

not_run: WebUI.callTestCase(findTestCase('com.tap.and.ride.guest.page/Verify_Trip_Details'), [:], FailureHandling.STOP_ON_FAILURE)
