...
not_run: WebUI.click(findTestObject('Object Repository/TapAndRide_Object_Repository/Page_Add Payment Card  NJ Transit/button_By Payment Card'))

not_run: WebUI.setText(findTestObject('Object Repository/TapAndRide_Object_Repository/Page_Add Payment Card  NJ Transit/input_Card Number'), 
    GlobalVariable.VISA)
