...
WebUI.setText(findTestObject('Object Repository/New Repo by Rashmi auto reload tickets/Page_Fare-Pay Dashboard  NJ Transit/input__route'), 
    '22')

WebUI.click(findTestObject('Object Repository/New Repo by Rashmi auto reload tickets/Page_Fare-Pay Dashboard  NJ Transit/li_22-North Bergen - Union City - Hoboken'))
...
not_run: WebUI.delay(120)

WebUI.callTestCase(findTestCase('1.com.db/g_subscrption'), [:], FailureHandling.STOP_ON_FAILURE)
