...
not_run: WebUI.callTestCase(findTestCase('com.Fare.Pay.Card.page/Enter_Card_nickname_VISA'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyEqual('94701', ttID //84701
    )
