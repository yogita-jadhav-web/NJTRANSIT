...
WebUI.scrollToElement(findTestObject('Object Repository/Page_Fare-Pay Dashboard  NJ Transit/span_UnregisterCard'), 0)
...
WebUI.verifyElementText(findTestObject('Admin_Portal_Master_Fare_Pay_Card_Object_Repo/p_No Data Found'), 'No Data Found')
