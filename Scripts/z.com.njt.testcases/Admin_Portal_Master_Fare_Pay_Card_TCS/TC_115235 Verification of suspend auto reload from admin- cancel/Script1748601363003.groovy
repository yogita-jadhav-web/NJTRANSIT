...
WebUI.callTestCase(findTestCase('com.admin.pages/FareCard_Page/cancel the popup -suspend AutoReload'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('com.admin.pages/FareCard_Page/Vealidate Fare card details'), [:], FailureHandling.STOP_ON_FAILURE)
