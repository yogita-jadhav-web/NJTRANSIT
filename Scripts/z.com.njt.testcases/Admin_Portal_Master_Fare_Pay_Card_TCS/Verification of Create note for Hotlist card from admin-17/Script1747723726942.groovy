...
WebUI.verifyElementPresent(findTestObject('Object Repository/Admin_Portal_Master_Fare_Pay_Card_Object_Repo/p_Your comments must be at least 5 characters'), 
    0)

WebUI.verifyElementPresent(findTestObject('Object Repository/Admin_Portal_Master_Fare_Pay_Card_Object_Repo/button_Cancel'), 
    0)

WebUI.verifyElementPresent(findTestObject('Object Repository/Admin_Portal_Master_Fare_Pay_Card_Object_Repo/p_Create Note'), 
    0)
