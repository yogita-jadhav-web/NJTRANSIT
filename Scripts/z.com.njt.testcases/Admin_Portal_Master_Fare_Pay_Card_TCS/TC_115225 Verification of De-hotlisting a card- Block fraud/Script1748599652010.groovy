...
WebUI.click(findTestObject('Fare_Card_Refund_Object_Repo/hotListReason-Fraud block'))
...
String hotListStatus = WebUI.getText(findTestObject('Fare_Card_Refund_Object_Repo/FarecardStatus-Blocked fraud_CP'))

WebUI.verifyEqual(hotListStatus, 'Blocked / Fraud')
...
WebUI.verifyEqual(portalCardStatus, 'Active')
