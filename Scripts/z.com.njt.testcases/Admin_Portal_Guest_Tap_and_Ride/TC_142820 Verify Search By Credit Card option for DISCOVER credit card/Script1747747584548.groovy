...
WebUI.callTestCase(findTestCase('com.admin.pages/Guest_Tap_and_Ride_page/Click_and_Verify_credit_card_radio_button'), [:], 
    FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('com.admin.pages/Guest_Tap_and_Ride_page/Enter Discover Card details'), [:], FailureHandling.STOP_ON_FAILURE)
