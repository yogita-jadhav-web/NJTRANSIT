...
not_run: String farePayCardNumber = WebUI.getText(findTestObject('Fare_Card_Refund_Object_Repo/FarePayCardNumberXpath'))
...
not_run: WebUI.click(findTestObject('Object Repository/Fare_Card_Refund_Object_Repo/button_Bus'))

not_run: WebUI.click(findTestObject('Object Repository/Fare_Card_Refund_Object_Repo/svg__MuiSvgIcon-root MuiSvgIcon-fontSizeMed_b3633d'))

not_run: WebUI.click(findTestObject('Object Repository/Fare_Card_Refund_Object_Repo/li_2-Jersey City - Journal Square - Secaucus'))

not_run: WebUI.delay(1)

not_run: WebUI.click(findTestObject('Fare_Card_Refund_Object_Repo/clickOnSelectTicketForBus'))

not_run: WebUI.click(findTestObject('Object Repository/Fare_Card_Refund_Object_Repo/input_Fare_r9'))
...
not_run: WebUI.click(findTestObject('Fare_Card_Refund_Object_Repo/hotListReason-defective'))
...
not_run: WebUI.verifyEqual('COMPLETED', refundStatusfromDB)
...
not_run: String succesfulHotlistText = WebUI.getText(findTestObject('Fare_Card_Refund_Object_Repo/UnHotListText'))

not_run: WebUI.verifyEqual(succesfulHotlistText, 'De-Hotlist Fare card is successful')
...
not_run: String refundReJtLink = WebUI.getText(findTestObject('Fare_Card_Refund_Object_Repo/RefundRejectLink'))

not_run: WebUI.verifyEqual(refundReJtLink, 'Refund Rejected')
