...
WebUI.click(findTestObject('Object Repository/Fare_Card_Refund_Object_Repo/li_River Line'))

WebUI.click(findTestObject('Fare_Card_Refund_Object_Repo/ClickOnSelectTraiff'))

WebUI.click(findTestObject('Object Repository/Fare_Card_Refund_Object_Repo/li_Within New Jersey'))

WebUI.click(findTestObject('Object Repository/Fare_Card_Refund_Object_Repo/button_Continue'))

WebUI.click(findTestObject('Object Repository/Fare_Card_Refund_Object_Repo/input_Select Plan_planMethods'))
