...
not_run: WebUI.verifyElementText(findTestObject('full_refund_Rail_10_trip/full_refund_Rail_10_trip/Pop up -1'), 'Purchase successful. Please check your transaction history for more information on your tickets, and check your email for the transaction receipt.')
...
WebUI.verifyElementText(findTestObject('full_refund_Rail_10_trip/Pop ups/Paragraph1-10Trip -Refund Policy pop up'), 'Wholly unused Ten-Trip tickets will be refunded at the purchase price. For partially used ten-trip tickets, the applicable full one-way fare will be deducted from the purchase price for each ticket used.')
...
WebUI.click(findTestObject('full_refund_Rail_10_trip/Pop ups/No button-Refund policy pop up'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementPresent(findTestObject('full_refund_Rail_10_trip/Page_Fare-Pay Dashboard  NJ Transit/button_TRX. History'), 
    10)
...
not_run: WebUI.click(findTestObject('full_refund_Rail_10_trip/Page_Fare-Pay Dashboard  NJ Transit/button_TRX. History'), 
    FailureHandling.STOP_ON_FAILURE)
