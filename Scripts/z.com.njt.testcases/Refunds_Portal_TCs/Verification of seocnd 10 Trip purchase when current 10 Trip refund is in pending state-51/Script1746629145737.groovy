...
WebUI.verifyElementPresent(findTestObject('full_refund_Rail_10_trip/full_refund_Rail_10_trip/refund pending-button'), 0)
...
not_run: WebUI.click(findTestObject('Object Repository/full_refund_Rail_10_trip/Page_Fare-Pay Dashboard  NJ Transit/li_Hoboken-NWK'))
...
WebUI.waitForElementPresent(findTestObject('Refund-Bus/Page_Fare-Pay Dashboard  NJ Transit/div_You are only allowed to purchase one ticket per validity period'), 
    5)
