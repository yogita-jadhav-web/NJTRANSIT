...
WebUI.callTestCase(findTestCase('com.Fare.Pay.Card.page/Buy_Tickets_Highland_AV to Liitle falls via summit'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('full_refund_Rail_10_trip/Page_Fare-Pay Dashboard  NJ Transit/Monthly Adult -Radio button'))
...
not_run: WebUI.verifyElementText(findTestObject('full_refund_Rail_10_trip/full_refund_Rail_10_trip/Pop up -1'), '')
...
dbWalletId = CustomKeywords.'com.web.db.NJT_Reload_Database.getWalletIdDetails'(dbconnection, query)

WebUI.verifyEqual('UEGY8VO0', dbWalletId)
