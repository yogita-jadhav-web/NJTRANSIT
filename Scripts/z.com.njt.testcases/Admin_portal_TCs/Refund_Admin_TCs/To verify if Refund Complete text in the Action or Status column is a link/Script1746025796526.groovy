...
WebUI.click(findTestObject('Object Repository/Admin portal _TC_objectRepo/Page_Conduent Transport Solutions, Inc/a_Refund Pending'), 
    FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Admin portal _TC_objectRepo/Page_Conduent Transport Solutions, Inc/close refund details pop up'))
