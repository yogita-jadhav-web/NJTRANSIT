...
not_run: WebUI.callTestCase(findTestCase('com.Fare.Pay.Card.page/Click_10Trip'), [:], FailureHandling.STOP_ON_FAILURE)
...
not_run: WebUI.callTestCase(findTestCase('com.login.admin.page/Verify_Refund Cmpleted pop up details vs Databsae'), [:], 
    FailureHandling.STOP_ON_FAILURE)
