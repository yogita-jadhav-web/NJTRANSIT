...
WebUI.click(findTestObject('Object Repository/Fare_Card_Refund_Object_Repo/Fare_Card_Refund_Object_Repo/li_Newark Light Rail'))

WebUI.click(findTestObject('Object Repository/Fare_Card_Refund_Object_Repo/Fare_Card_Refund_Object_Repo/button_Continue'))

not_run: passAmount = WebUI.getText(findTestObject('Fare_Card_Refund_Object_Repo/passAmountWhileAutoReload'))

not_run: println(passAmount)
...
fullText = WebUI.getText(findTestObject('Page_Fare-Pay Dashboard  NJ Transit/div_credit_card_fullText'))
...
WebUI.verifyEqual(paymentcardNum, creditCardNumber_from_P_SUB_TRNX_Table)
