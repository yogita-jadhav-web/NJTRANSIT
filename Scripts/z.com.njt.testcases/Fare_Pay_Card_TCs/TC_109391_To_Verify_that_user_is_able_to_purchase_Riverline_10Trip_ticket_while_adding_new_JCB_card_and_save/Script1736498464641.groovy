...
not_run: WebUI.callTestCase(findTestCase('com.Fare.Pay.Card.page/Enter_JCB_CC_Details'), [:], FailureHandling.STOP_ON_FAILURE)
...
not_run: WebUI.callTestCase(findTestCase('com.Fare.Pay.Card.page/select_existing_credit_card'), [:], FailureHandling.STOP_ON_FAILURE)
