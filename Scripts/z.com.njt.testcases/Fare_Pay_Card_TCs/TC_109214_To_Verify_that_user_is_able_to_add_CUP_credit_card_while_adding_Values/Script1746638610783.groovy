...
WebUI.callTestCase(findTestCase('com.Fare.Pay.Card.page/Enter_credit_card_details'), [('cardType') : 'CUP'], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('com.Fare.Pay.Card.page/select_existing_credit_card'), [('cardType') : 'CUP'], FailureHandling.STOP_ON_FAILURE)
