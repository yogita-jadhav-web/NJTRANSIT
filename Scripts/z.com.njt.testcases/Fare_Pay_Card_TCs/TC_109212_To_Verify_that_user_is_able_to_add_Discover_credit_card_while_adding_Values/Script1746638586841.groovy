...
WebUI.callTestCase(findTestCase('com.Fare.Pay.Card.page/Enter_credit_card_details'), [('cardType') : 'Discover'], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('com.Fare.Pay.Card.page/Enter_Random_Card_nickname'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('com.Fare.Pay.Card.page/click_on_add_new_card_button_add_value_screen'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('com.profile.page/Verify_Payment Card Added Successfully'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('com.Fare.Pay.Card.page/select_existing_credit_card'), [('cardType') : 'Master'], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('com.Fare.Pay.Card.page/Verify_Added_credit_card_should_display_In_Manage_saved_payments'), 
