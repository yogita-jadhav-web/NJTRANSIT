...
WebUI.callTestCase(findTestCase('com.Fare.Pay.Card.page/Enter_credit_card_details'), [('cardType') : 'JCB'], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('com.Fare.Pay.Card.page/select_existing_credit_card'), [('cardType') : 'JCB'], FailureHandling.STOP_ON_FAILURE)
