...
/*
String expectedMessage  = MessageReader.getMessage("Email")

println ('expectedMessage : '+expectedMessage)
WebUI.verifyElementText(findTestObject('Page_Sign In  NJ Transit/p_Email is required'), expectedMessage )
*/