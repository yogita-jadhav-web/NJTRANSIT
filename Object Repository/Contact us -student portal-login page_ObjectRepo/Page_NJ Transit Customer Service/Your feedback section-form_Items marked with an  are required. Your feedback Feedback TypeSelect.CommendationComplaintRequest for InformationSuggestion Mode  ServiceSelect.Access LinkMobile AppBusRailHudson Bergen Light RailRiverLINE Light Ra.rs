...
<WebElementEntity>
   ...
   <name>Your feedback section-form_Items marked with an  are required. Your feedback Feedback TypeSelect.CommendationComplaintRequest for InformationSuggestion Mode  ServiceSelect.Access LinkMobile AppBusRailHudson Bergen Light RailRiverLINE Light Ra</name>
   <tag></tag>
